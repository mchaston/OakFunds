 ...
 */
class ModelCreateServlet extends HttpServlet {
  ...
  @Inject
  ModelCreateServlet(RequestHandler requestHandler,
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    final JSONObject jsonRequest = JSONUtils.readRequest(request, "create model");
    Model model =
        requestHandler.handleTransaction(request, response,
            new RequestHandler.Action<Model>() {
              ...
              public Model doAction(HttpServletRequest request)
                ...
                return modelManager.createNewModel(PARAMETER_TITLE.parse(jsonRequest));
              }
            });
